...
#include <avr/io.h>        // Pour les registres (TCNT1, OCR1A, TCCR1A, etc.)
#include <avr/interrupt.h> // Pour ISR(), sei(), cli(), TIMER1_COMPA_vect

#ifndef F_CPU
#error "F_CPU need to be defined in Makefile"
#endif
...
uint32_t timer_millis(void)
{
    ...
    SREG = sreg; //Status Register (SREG)
